---
title: Típusok
description: A böngésző natív HTML elemeinek kiterjesztése a maximális testreszabhatóság érdekében.
---
...
As we discussed in [Kompozíció](/composition), this approach creates several problems:
- Nem tudod testreszabni a fejléc stílusát további props-ok hozzáadása nélkül
- Nem tudod szabályozni a title és description számára használt HTML elemeket
- Egy meghatározott DOM struktúrára kényszerülsz
...
- **Maximális testreszabhatóság** - A felhasználók külön-külön formázhatják és módosíthatják az egyes rétegeket
- **Nincs props-ok továbbítása (prop drilling)** - A props közvetlenül oda kerülnek, ahol szükség van rájuk
- **Szemantikus HTML** - A felhasználók láthatják és szabályozhatják a pontos DOM struktúrát
- **Jobb akadálymentesítés** - Közvetlen irányítás az ARIA attribútumok és szemantikus elemek felett
- **Egyszerűbb mentális modell** - Egy komponens = egy elem
