...
description: Construirea de componente utilizabile de către toată lumea, inclusiv utilizatorii cu dizabilități care se bazează pe tehnologii asistive.
---
...
Dacă folosiți un linter cu reguli stricte de accesibilitate precum [Ultracite](https://www.ultracite.ai), astfel de probleme vor fi probabil detectate automat, dar este totuși important să înțelegeți principiile.
...
Elementele semantice includ anunțuri de rol adecvate, interacțiune cu tastatura, gestionarea focusului și participare la formulare.
...
1. Nu folosiți ARIA dacă puteți folosi HTML semantic
2. Nu schimbați semantica nativă decât dacă este necesar
3. Toate elementele interactive trebuie să fie accesibile de la tastatură
4. Nu ascundeți elementele focusabile de tehnologiile asistive
5. Toate elementele interactive trebuie să aibă nume accesibile
...
### Elemente de formular dezactivate
