---
title: Polymorfism
description: Hur du använder `as`-prop:en för att ändra det renderade HTML-elementet samtidigt som komponentens funktionalitet bevaras.
---
...
Populärgjort av bibliotek som [Styled Components](https://styled-components.com/), [Emotion](https://emotion.sh/), och [Chakra UI](https://chakra-ui.com/), ger detta mönster flexibilitet att välja semantisk HTML samtidigt som komponentens styling och beteende bevaras.
...
[Radix UI](https://www.radix-ui.com/) tillhandahåller en `Slot`-komponent som erbjuder ett kraftfullare alternativ till `as`-prop-mönstret. Istället för att bara ändra elementtypen slår `Slot` ihop props med barnelementet, vilket möjliggör kompositionsmönster.
...
| **Elementtyp** | Specificerad i prop | Härledd från barnet |
| **Komponentkomposition** | Begränsad | Fullt stöd |
| **Sammanfogning av props** | Grundläggande spridning | Intelligent sammanslagning |
| **Ref-vidarebefordran** | Kräver manuell setup | Inbyggt |
| **Händelsehanterare** | Kan krocka | Sammansätts korrekt |
| **Biblioteksstorlek** | Ingen beroende | Kräver `@radix-ui/react-slot` |
